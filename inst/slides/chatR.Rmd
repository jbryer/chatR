...
author: Jason Bryer, Ph.D.<br/>Assistant Professor, CUNY School of Professional Studies
...
.pull-right[
```{r, echo=FALSE}
knitr::include_graphics('images/ragner_screenshot.png')
```
]

---
# Inspecting the knowledge store (cont.)
...
All of this put together for you in a script. Just set the `website_urls` to the list of websites you want to index and run the script.

https://github.com/jbryer/chatR/blob/master/data-raw/build_vector_store.R
